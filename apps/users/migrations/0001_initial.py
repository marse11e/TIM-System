    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Администратор'), ('observer', 'Наблюдатель'), ('user', 'Пользователь'), ('accountant', 'Бухгалтер'), ('warehouse', 'Кладовщик')], default='user', max_length=20, verbose_name='Роль')),
